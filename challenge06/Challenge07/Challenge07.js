...
const objLat = (obj) => {
  ...
  return`my name is ${obj.firstName[0].toUpperCase()}${obj.firstName.substring(1)} 
  ${obj.lastName[0].toUpperCase()}${obj.lastName.substring(1)} I am ${obj.age} YO, and I love ${obj.hobby}.`   
};
...
//  fullName and tech if the applicant has more than one year of Experience
 // write your code here
    // let fN = `my name is ${obj.firstName} ${obj.lastName} I am ${obj.age} Yo and I love ${obj.hobby}`;
    // return fN;
// EX:
let cvs = [
    {
...
const cvFormatter = (arr) => {
    ...
    for (const [key, value] of Object.entries(cvs)) {
